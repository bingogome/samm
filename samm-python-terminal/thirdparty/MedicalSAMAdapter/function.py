...
from .cfg import *
from .models.sam.utils import transforms as samtrans
        ...
        for pack in train_loader:
            ...
            if point_labels[0] != -1:
                ...
                coords_torch = torch.as_tensor(
                    point_coords, dtype=torch.float, device=GPUdevice
                )
                labels_torch = torch.as_tensor(
                    point_labels, dtype=torch.int, device=GPUdevice
                )
            ...
            with torch.no_grad():
                if args.net == "sam" or args.net == "mobile_sam":
                    ...
                    coords_torch, labels_torch = transform_prompt(
                        coords_torch, labels_torch, h, w
                    )
